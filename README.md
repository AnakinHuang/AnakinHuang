...
🧬 Working at the intersection of AI, single-cell genomics, and systems  
...
I’m a computer scientist and researcher interested in how modern ML and foundation models can be used to understand complex systems — from disease-associated brain cell states to end-to-end AI music generation. I enjoy building things that actually run: reproducible pipelines, research code that other people can use, and small systems that behave like “real” tools rather than class demos.
...
*Training Generative AI to Identify Disease-Associated Cell States* (May 2025 – Present)  
...
### [Milo Music: AI-Powered Music Creation Platform](https://github.com/futurespyhi/MiloMusic)
...
**University of Rochester – M.S. in Computer Science**  
Rochester, NY • Aug 2024 – Present  

- GPA: 3.95/4.00  
- Graduate Tuition Scholarship (50% of full-time tuition cost)  
- A’s in all core CS courses (NLP, Machine Vision, Parallel & Distributed Systems, Databases, Networks, etc.)

**University of Rochester – B.S. in Computer Science**  
Rochester, NY • Aug 2021 – Dec 2023  

- GPA: 3.96/4.00  
- Merit-based Tuition Scholarship ($5,000)  
- Dean’s List every semester; A’s in all CS and Math major courses  
...
**Teaching Assistant**  
*University of Rochester* (Sep 2022 – Dec 2023)  
...
*VISION X LLC, San Jose, CA* (Aug 2020 – Oct 2020)  
...
If you’d like to collaborate, feel free to open an issue, start a discussion, or reach out by email.
